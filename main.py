...
pipe_clf = joblib.load(open(r"C:\Users\ksank\OneDrive\Desktop\Emotion-detection-NLP-project\emotion-detection-nlp-project\model\Emotion_intensity_SVM.pkl", "rb"))
